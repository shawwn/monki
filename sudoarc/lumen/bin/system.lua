...
return({["file-exists?"] = file_exists63, ["path-separator"] = path_separator, write = write, argv = argv, exit = exit, ["read-file"] = read_file, ["write-file"] = write_file, ["path-join"] = path_join, ["get-environment-variable"] = get_environment_variable})
